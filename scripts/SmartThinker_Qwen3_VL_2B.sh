...
MODEL_PATH=${MODEL_PATH:-"/home/huchenzhi/models/Qwen/Qwen3-VL-2B-Thinking"}

use_dynamic_bsz=True

# Train over a single node, 4 PRO6000-96GB GPUs.
CUDA_VISIBLE_DEVICES=0,1 python3 ${PROJECT_HOME}/src/trainer/main_SmartThinker.py \
    ...
    trainer.project_name='SmartThinker-VL' \
    trainer.experiment_name='Qwen3-VL-2B-thinking' \
