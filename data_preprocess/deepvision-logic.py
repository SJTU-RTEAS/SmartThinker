...
if __name__ == "__main__":
    ...
    if local_dataset_path is not None:
        dataset = datasets.load_dataset("parquet", data_files=os.path.join(local_dataset_path, "visual_logic-26k.parquet"))
    else:
        dataset = datasets.load_dataset(data_source, "visual_logic")
    ...
    train_dataset.to_parquet(os.path.join(local_save_dir, "deepvision-logic.parquet"))
